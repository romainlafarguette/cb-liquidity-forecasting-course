% Time-stamp: <2022-11-09 23:36:04 A13258Q>
...
\begin{frame}
  ...
  \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{../static/course_2_img/cb_balance_sheet.PNG}}
...
\begin{frame}
  ...
  \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{../static/course_2_img/policy_position.PNG}}
  \hspace*{15pt}\hbox{\scriptsize Credit:\thinspace{\scriptsize\itshape Author}}
\end{frame}
...
\begin{frame}
  \frametitle{Autonomous Factors Drivers}
  \makebox[\linewidth]{\includegraphics[width=0.85\paperwidth]{../static/course_2_img/drivers_autonomous_factors.PNG}}
  \hspace*{15pt}\hbox{\scriptsize Credit:\thinspace{\scriptsize\itshape Author}}
\end{frame}


\begin{frame}
  \frametitle{Use Specific Models for Each Autonomous Factor}
  \makebox[\linewidth]{\includegraphics[width=0.85\paperwidth]{../static/course_2_img/driver_specific.PNG}}
  \hspace*{15pt}\hbox{\scriptsize Credit:\thinspace{\scriptsize\itshape Author}}
\end{frame}
...
\begin{frame}
  ...
  \makebox[\linewidth]{\includegraphics[width=0.85\paperwidth]{../static/course_2_img/main_references.PNG}}
  %\hspace*{15pt}\hbox{\scriptsize Credit:\thinspace{\scriptsize\itshape Self}}
\end{frame}

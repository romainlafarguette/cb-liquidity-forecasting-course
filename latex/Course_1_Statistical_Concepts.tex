% Time-stamp: <2022-10-27 14:00:35 ubuntu>
...
%% Title info
%% ---------------------------------------------------------------------------
\title[Concepts]{A Gentle Introduction to Time Series Statistical Concepts}
...
\begin{frame}
  ...
  Statistical data can be organized into:
  \begin{wideitemize}
    \item \textbf{Time series data}: One data series, with a set of dates
    \item \textbf{Panel data}: data of one or more variable, organized by (i) unit and (ii) time
    \item \textbf{Pooled data}
  \end{wideitemize}
\end{frame}

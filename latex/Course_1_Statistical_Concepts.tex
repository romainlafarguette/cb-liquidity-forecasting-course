% Time-stamp: <2022-11-08 02:59:42 A13258Q>
...
\end{frame}
  ...
  \begin{frame}
    ...
    \makebox[\linewidth]{\includegraphics[height=0.4\paperheight]{../static/course_1_img/simpson_1.PNG}}
  ...
  \begin{frame}
    \frametitle{Pay Attention to Conditioning: Simpson Paradox}
